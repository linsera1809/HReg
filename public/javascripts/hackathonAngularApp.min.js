...
angular.module("hackathonRegistrationApp",[]),angular.module("hackathonRegistrationApp").factory("team",["$http","$window","$httpParamSerializer",function(n,o,e){var t={registerTeam:function(t){return n.post("/api/register-team",t).then(function(t){o.location.href="/dev-output/?"+e(t.data)},function(t){o.location.href="/dev-output/?"+e(t.data)})}};return t}]),angular.module("hackathonRegistrationApp").factory("user",["$http",function(o){var t={login:function(t){return o.post("/user/login",t).then(function(t){return t},function(t){return t})},signup:function(t){return o.post("/user/signup",t).then(function(t){return t},function(t){return t})},changePassword:function(t){return o.post("/user/change-password",t).then(function(t){return t},function(t){return t})},forgotPassword:function(t){return o.post("/user/forgot-password",{email:t}).then(function(t){return t},function(t){return t})},resetPassword:function(t){var n={password:t.password,confirmPassword:t.confirmPassword};return o.post("/user/reset-password/"+t.query,n).then(function(t){return t},function(t){return t})}};return t}]),angular.module("hackathonRegistrationApp").component("changePassword",{templateUrl:"change-password/change-password.template.html",controller:["user",function(t){var n=this;n.creds={},n.error=[],n.changePassword=function(){t.changePassword(n.creds).then(function(t){200==t.status?(n.message=t.data,n.error=[]):(n.message=void 0,n.error=t.data)})}}]}),angular.module("hackathonRegistrationApp").component("countdown",{templateUrl:"countdown/countdown.template.html",controller:["$interval",function(t){var o=this;function n(){var t=(new Date).getTime(),n=o.countDownDate-t;return 0<=n?(o.days=Math.floor(n/864e5),o.hours=Math.floor(n%864e5/36e5),o.minutes=Math.floor(n%36e5/6e4),o.seconds=Math.floor(n%6e4/1e3)):(o.days=0,o.hours=0,o.minutes=0,o.seconds=0),n}o.$onChanges=function(){o.countDownDate=new Date(o.countdownTimestamp).getTime(),distance=n(),0<distance?(o.showCountdown=!0,o.counter=t(function(){n()<0&&(t.cancel(o.counter),o.countdownOver({over:!0}))},1e3)):o.countdownOver({over:!0})}}],bindings:{countdownTimestamp:"@",countdownOver:"&"}}),angular.module("hackathonRegistrationApp").component("forgotPassword",{templateUrl:"forgot-password/forgot-password.template.html",controller:["user",function(t){var n=this;n.forgotPassword=function(){t.forgotPassword(n.email).then(function(t){200==t.status?(n.message=t.data,n.error=void 0):(n.message=void 0,n.error=t.data)})}}]}),angular.module("hackathonRegistrationApp").component("login",{templateUrl:"login/login.template.html",controller:["user","$window",function(t,n){var o=this;o.creds={},o.login=function(){t.login(o.creds).then(function(t){200==t.status?t.data.returnToPage?n.location.href=t.data.returnToPage:n.location.href="/":o.error=t.data})}}]}),angular.module("hackathonRegistrationApp").component("loginButton",{templateUrl:"login-button/login-button.template.html",controller:["$interval",function(){var n=this;n.$onInit=function(){n.showLogin=!1},n.countdownOver=function(t){t&&(n.showLogin=!0)}}],bindings:{countdownTimestamp:"@"}}),angular.module("hackathonRegistrationApp").component("resetPasswordForm",{templateUrl:"reset-password-form/reset-password-form.template.html",controller:["user","$window",function(t,n){var o=this;o.reset={},o.error=[],o.resetPassword=function(){o.reset.query=n.location.search,t.resetPassword(o.reset).then(function(t){200==t.status?(o.message=t.data,o.error=[],console.log(t)):(o.message=void 0,o.error=t.data)})}}]}),angular.module("hackathonRegistrationApp").component("signup",{templateUrl:"signup/signup.template.html",controller:["user",function(t){var n=this;n.$onInit=function(){n.user={},n.error=[],n.terms=!1},n.$onChanges=function(){n.tshirtSizes=n.tshirtSizes.split(",")},n.signup=function(){t.signup(n.user).then(function(t){200==t.status?(n.message=t.data,n.error=[]):(n.message=void 0,n.error=t.data)})}}],bindings:{tshirtSizes:"@"}}),angular.module("hackathonRegistrationApp").component("teamRegistration",{templateUrl:"team-registration/team-registration.template.html",controller:["team",function(t){var n=this;n.$onInit=function(){n.team={},n.team.members=[]},n.registerTeam=function(){t.registerTeam(n.team)}}]});


angular.module("hackathonRegistrationApp").run(["$templateCache",function(r){r.put("change-password/change-password.template.html",'<form>\r\n  <p class="error" ng-repeat="(key, value) in $ctrl.error">{{value}}</p>\r\n  <label for="old-password">Old Password</label>\r\n  <input id="old-password" type="password" ng-model="$ctrl.creds.oldPassword">\r\n\r\n  <label for="password">New Password</label>\r\n  <input id="password" type="password" ng-model="$ctrl.creds.password">\r\n\r\n  <label for="confirm-password">Confirm Password</label>\r\n  <input id="confirm-password" type="password" ng-model="$ctrl.creds.confirmPassword">\r\n\r\n  <button ng-click="$ctrl.changePassword()">Change Password</button>\r\n  <p ng-if="$ctrl.message">{{$ctrl.message}}</p>\r\n</form>\r\n'),r.put("forgot-password/forgot-password.template.html",'<form>\r\n  <p class="error" ng-if="$ctrl.error">{{$ctrl.error}}</p>\r\n  <label for="email">Email</label>\r\n  <input id="email" type="text" ng-model="$ctrl.email">\r\n\r\n  <button ng-click="$ctrl.forgotPassword()">Reset My Password</button>\r\n  <p ng-if="$ctrl.message">{{$ctrl.message}}</p>\r\n</form>\r\n'),r.put("login-button/login-button.template.html",'<countdown countdown-timestamp="{{$ctrl.countdownTimestamp}}" countdown-over="$ctrl.countdownOver(over)" ng-show="!$ctrl.showLogin"></countdown>\r\n<form id="login-button" action="/login" ng-show="$ctrl.showLogin">\r\n  <button class="hackathon-font">Login</button>\r\n</form>\r\n'),r.put("login/login.template.html",'<form>\r\n  <p class="error" ng-if="$ctrl.error">{{$ctrl.error}}</p>\r\n  <label for="login-email">Email</label>\r\n  <input id="login-email" type="text" ng-model="$ctrl.creds.email">\r\n\r\n  <label for="login-password">Password</label>\r\n  <input id="login-password" type="password" ng-model="$ctrl.creds.password">\r\n\r\n  <button ng-click="$ctrl.login()">Login</button>\r\n</form>\r\n<a href="/forgot-password">Forgot Password</a><br>\r\n<a href="/create-account">Create Account</a><br>\r\n'),r.put("reset-password-form/reset-password-form.template.html",'<form>\r\n  <p class="error" ng-repeat="(key, value) in $ctrl.error">{{value}}</p>\r\n  <label>New Password</label>\r\n  <input type="password" ng-model="$ctrl.reset.password">\r\n\r\n  <label>Confirm Password</label>\r\n  <input type="password" ng-model="$ctrl.reset.confirmPassword">\r\n\r\n  <button ng-click="$ctrl.resetPassword()">Reset Password</button>\r\n  <p ng-if="$ctrl.message">{{$ctrl.message}}</p>\r\n</form>\r\n<br>\r\n<br>\r\n<h5>Password Requirements</h5>\r\n<p>Passwords must be a minimum of 8 characters long and contain 3 of following 4</p>\r\n<ol>\r\n  <li>Lower Case Letter</li>\r\n  <li>Uperr Case Letter</li>\r\n  <li>Number</li>\r\n  <li>Special Character: ! @ # $ % ^ &amp; * ( ) + = . _ - </li>\r\n</ol>\r\n'),r.put("signup/signup.template.html",'<form>\r\n  <p class="error" ng-repeat="(key, value) in $ctrl.error">{{value}}</p>\r\n\r\n\r\n  \x3c!-- First Name --\x3e\r\n  <label for="first-name">First Name</label>\r\n  <input id="first-name" type="text" ng-model="$ctrl.user.firstName">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Last Name --\x3e\r\n  <label for="last-name">Last Name</label>\r\n  <input id="last-name" type="text" ng-model="$ctrl.user.lastName">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Email --\x3e\r\n  <label for="email">Nationwide Email</label>\r\n  <input id="email" type="text" ng-model="$ctrl.user.email">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Cell Phone --\x3e\r\n  <label for="cell">Cell Phone</label>\r\n  <input id="cell" type="text" ng-model="$ctrl.user.cell">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Password --\x3e\r\n  <label for="signup-password">Password</label>\r\n  <input id="signup-password" type="password" ng-model="$ctrl.user.password">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Confirm Password --\x3e\r\n  <label for="signup-confirmPassword">Confirm Password</label>\r\n  <input id="signup-confirmPassword" type="password" ng-model="$ctrl.user.confirmPassword">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- T-Shirt Size --\x3e\r\n  <label for="tshirt">T-Shirt Size</label>\r\n  <select id="tshirt" ng-options="size for size in $ctrl.tshirtSizes" ng-model="$ctrl.user.tshirt"></select>\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Team Role --\x3e\r\n  <label for="team-role">Team Role</label>\r\n  <input id="team-role" type="text" ng-model="$ctrl.user.role">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Dietary Restrictions --\x3e\r\n  <label for="diet">Dietary Restrictions</label>\r\n  <textarea id="diet" ng-model="$ctrl.user.diet"></textarea>\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Terms and Conditions --\x3e\r\n  <p>\r\n    I understand that in order for me to participate in the Hackathon I must\r\n    be a member of a completely registered team. Creating an account DOES NOT\r\n    register me for the Hackathon.\r\n  </p>\r\n  <input type="checkbox" id="terms" ng-model="$ctrl.user.terms"><label for="terms"> I Agree</label>\r\n  <br>\r\n  <br>\r\n\r\n  <button ng-click="$ctrl.signup()">Create Account</button>\r\n  <p ng-if="$ctrl.message">{{$ctrl.message}}</p>\r\n</form>\r\n<br>\r\n<br>\r\n<h5>Password Requirements</h5>\r\n<p>Passwords must be a minimum of 8 characters long and contain 3 of following 4</p>\r\n<ol>\r\n  <li>Lower Case Letter</li>\r\n  <li>Uperr Case Letter</li>\r\n  <li>Number</li>\r\n  <li>Special Character: ! @ # $ % ^ &amp; * ( ) + = . _ - </li>\r\n</ol>\r\n'),r.put("team-registration/team-registration.template.html",'<form id="team-registration">\r\n  \x3c!-- Team Name --\x3e\r\n  <label for="team-name">Team Name</label>\r\n  <input id="team-name" type="text" ng-model="$ctrl.teamName">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Member 1 --\x3e\r\n  <label for="member1">Member 1 Email Address</label>\r\n  <input id="member1" type="text" ng-model="$ctrl.team.members[0]">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Member 2 --\x3e\r\n  <label for="member2">Member 2 Email Address</label>\r\n  <input id="member2" type="text" ng-model="$ctrl.team.members[1]">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Member 3 --\x3e\r\n  <label for="member3">Member 3 Email Address</label>\r\n  <input id="member3" type="text" ng-model="$ctrl.team.members[2]">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Member 4 --\x3e\r\n  <label for="member4">Member 4 Email Address</label>\r\n  <input id="member4" type="text" ng-model="$ctrl.team.members[3]">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Member 5 --\x3e\r\n  <label for="member5">Member 5 Email Address</label>\r\n  <input id="member5" type="text" ng-model="$ctrl.team.members[4]">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Member 6 --\x3e\r\n  <label for="member6">Member 6 Email Address</label>\r\n  <input id="member6" type="text" ng-model="$ctrl.team.members[5]">\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- App Idea --\x3e\r\n  <label for="app-idea">App Idea</label>\r\n  <textarea id="app-idea" ng-model="$ctrl.team.appIdea"></textarea>\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Technology --\x3e\r\n  <label for="technology">Technology</label>\r\n  <textarea id="technology" ng-model="$ctrl.team.technology"></textarea>\r\n  <br>\r\n  <br>\r\n\r\n  \x3c!-- Computing Platform --\x3e\r\n  <label for="computing-platform">Computing Platform</label>\r\n  <textarea id="computing-platform" ng-model="$ctrl.team.platform"></textarea>\r\n  <br>\r\n  <br>\r\n\r\n  <button ng-click="$ctrl.registerTeam()">Register Team</button>\r\n</form>\r\n'),r.put("countdown/countdown.template.html",'<div id="countdown">\r\n  \x3c!-- Days --\x3e\r\n  <div>\r\n    <div class="number">{{$ctrl.days}}</div>\r\n    <div class="text">Days</div>\r\n  </div>\r\n\r\n  \x3c!-- Colon --\x3e\r\n  <div class="colon">:</div>\r\n\r\n  \x3c!-- Hours --\x3e\r\n  <div>\r\n    <div class="number">{{$ctrl.hours}}</div>\r\n    <div class="text">Hours</div>\r\n  </div>\r\n\r\n  \x3c!-- Colon --\x3e\r\n  <div class="colon">:</div>\r\n\r\n  \x3c!-- Minutes --\x3e\r\n  <div>\r\n    <div class="number">{{$ctrl.minutes}}</div>\r\n    <div class="text">Minutes</div>\r\n  </div>\r\n\r\n  \x3c!-- Colon --\x3e\r\n  <div class="colon">:</div>\r\n\r\n  \x3c!-- Seconds --\x3e\r\n  <div>\r\n    <div class="number">{{$ctrl.seconds}}</div>\r\n    <div class="text">Seconds</div>\r\n  </div>\r\n</div>\r\n')}]);


//# sourceMappingURL=hackathonAngularApp.min.js.map
